...
- **ABN Gateway Module Version**: 1.13.6
...
| ABN Gateway Module | ^1.13.1 | [two-inc/magento-abn-plugin](https://github.com/two-inc/magento-abn-plugin)                                             |
...
1. Check the module is enabled: `php bin/magento module:status | grep ABN_GatewayHyva`
2. Navigate to your store's frontend checkout page
3. Verify that the ABN Gateway payment method is visible
...
For developers looking to extend or customize the ABN Gateway Hyva module, follow these steps:
