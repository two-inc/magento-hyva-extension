...
const PHP_VALUE_RULES = [
  ...
  // Templates that use the value more than once hoist it into a local.
  ...
  // Production's default '{}'; sole-trader-flow.test.js overrides it to cover
  // the header(s) reaching SoleTrader.fetchBuyer().
  [
